...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="12" style="text-align:center; color:#64748b;">No allocations match the selected filters.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    <div class="footer">{{ $institution['name'] }} · Hostel Allocations</div>
</body>
</html>
