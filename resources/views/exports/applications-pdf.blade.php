    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 12%;">{{ $referenceLabel }}</th>
                <th style="width: 14%;">Programme</th>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="10" style="text-align:center; color:#64748b;">No applications match the selected filters.</td>
                </tr>
            @endforelse
        </tbody>
    </table>

    <div class="footer">{{ $institution['name'] }} · Admissions report</div>
</body>
</html>
