...
class BroadsheetStandingTest extends TestCase
{
    ...
    public function test_admin_remark_outranks_gpa_and_sanction_outranks_remark(): void
    {
        $this->assertSame('ABS_P', BroadsheetStanding::classify(5.0, 0, '2020', [], true, false, null, 'abs_p'));
        $this->assertSame('SICK', BroadsheetStanding::classify(5.0, 0, '2020', [], true, false, null, 'sick'));
        $this->assertSame('RUS', BroadsheetStanding::classify(5.0, 0, '2020', [], true, false, 'rusticated', 'abs_p'));
    }
    ...
    public function test_unscored_remarks_map_to_summary_codes(): void
    {
        ...
        $this->assertSame('AR', BroadsheetStanding::classify(null, 0, '2020', [], false, true));
        $this->assertSame('AR', BroadsheetStanding::classify(2.0, 0, '2020', [], true, true));
        $this->assertSame('GS', BroadsheetStanding::classify(2.0, 0, '2020', ['ar'], true, false, null, 'ar'));
    }
    ...
    public function test_scored_papers_use_gs_unless_incomplete(): void
    {
        ...
        $this->assertSame('AR', BroadsheetStanding::classify(2.0, 3, '2020', [], true, true));
