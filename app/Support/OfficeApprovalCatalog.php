...
class OfficeApprovalCatalog
{
    ...
    public static function actions(): array
    {
        $actions = [
            ...
            'admissions.destroy' => ['nav_key' => 'admissions-undergraduate', 'label' => 'Delete application file', 'mutation' => self::MUTATION_DELETE],
            ...
            'academic.sync_unit_limits' => ['nav_key' => 'unit-limits', 'label' => 'Save unit limit schedule', 'mutation' => self::MUTATION_UPSERT],
            'academic.destroy_unit_limit_group' => ['nav_key' => 'unit-limits', 'label' => 'Delete unit limit schedule', 'mutation' => self::MUTATION_DELETE],
            ...
            'students.term_remark' => ['nav_key' => 'results-students', 'label' => 'Record sitting remark', 'mutation' => self::MUTATION_UPDATE],
            'students.lift_term_remark' => ['nav_key' => 'results-students', 'label' => 'Lift sitting remark', 'mutation' => self::MUTATION_UPDATE],
            ...
            'results.department_submit' => ['nav_key' => 'results-department', 'label' => 'Department submit results', 'mutation' => self::MUTATION_UPDATE],
            'results.submit' => ['nav_key' => 'results-college', 'label' => 'College submit results', 'mutation' => self::MUTATION_UPDATE],
            'results.college_return' => ['nav_key' => 'results-college', 'label' => 'College return results', 'mutation' => self::MUTATION_UPDATE],
            ...
            'settings.upload_pg_signatory_signature' => ['nav_key' => 'application-settings', 'label' => 'Upload postgraduate admission signature', 'mutation' => self::MUTATION_UPDATE],
            'settings.delete_pg_signatory_signature' => ['nav_key' => 'application-settings', 'label' => 'Remove postgraduate admission signature', 'mutation' => self::MUTATION_DELETE],
