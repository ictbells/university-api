...
class OfficeApprovalCatalog
{
    ...
    public static function actions(): array
    {
        $actions = [
            ...
            'academic.store_intake' => ['nav_key' => 'intakes', 'label' => 'Create application window', 'mutation' => self::MUTATION_CREATE],
            'academic.update_intake' => ['nav_key' => 'intakes', 'label' => 'Update application window', 'mutation' => self::MUTATION_UPDATE],
            'academic.destroy_intake' => ['nav_key' => 'intakes', 'label' => 'Delete application window', 'mutation' => self::MUTATION_DELETE],
