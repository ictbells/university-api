...
class OfficeApprovalCatalog
{
    ...
    public static function actions(): array
    {
        $actions = [
            ...
            'students.term_remark' => ['nav_key' => 'students', 'label' => 'Record term remark', 'mutation' => self::MUTATION_UPDATE],
            'students.lift_term_remark' => ['nav_key' => 'students', 'label' => 'Lift term remark', 'mutation' => self::MUTATION_UPDATE],
