...
class StaffNavCatalog
{
    public static function all(): array
    {
        return [
            ...
            ['key' => 'results-import', 'section' => 'Academic', 'label' => 'CSV import', 'perm' => 'results.import'],
            ['key' => 'results-department', 'section' => 'Academic', 'label' => 'Department uploads', 'perm' => 'results.submit'],
            ['key' => 'results-approvals', 'section' => 'Academic', 'label' => 'Faculty Approval', 'perm' => 'results.faculty_approve'],
            ...
            ['key' => 'transcript-requests', 'section' => 'Services', 'label' => 'Transcript requests', 'perm' => 'transcripts.view'],
