...
class StaffNavCatalog
{
    public static function all(): array
    {
        return [
            ...
            ['key' => 'sessions', 'section' => 'Academic', 'label' => 'Admission sessions', 'perm' => 'academic.sessions.manage'],
            ...
            ['key' => 'results-approvals', 'section' => 'Academic', 'label' => 'Result approvals', 'perm' => 'results.submit'],
