    ...
    public function template(): StreamedResponse
    {
        return SpreadsheetImport::templateDownload(
            ...
            [
                ...
                '2. Keep the header row on the Invoices sheet. One row is one invoice. Extra rows with the same invoice_number add extra payments.',
                ...
                '4. Copy category from the Categories sheet (column category). Do not invent category codes.',
                '5. Sample row 1 is a paid tuition installment (matric). Sample row 2 is a paid application_fee (APP + JAMB) for applicant migration.',
                '6. For applicant migration, use category application_fee with application_number or jamb_registration; Import applicants posts matching paid rows, or generates an unpaid fee if none match.',
                '7. Tuition rows require installment_percent: 25, 50, 75, or 100.',
                '8. paid_amount is recorded on the invoice. It does not credit the wallet. Use Import wallet history for wallet credits/debits.',
                '9. If paid_amount is greater than 0, payment_date and payment_method are required. Method: legacy_import, bank_transfer, cash, pos, paystack.',
                '10. Duplicate payment_reference values are skipped.',
                '',
            ...
            InvoiceImportColumns::samples(),
            'invoice-import-template.xlsx',
            [InvoiceImportColumns::categoriesSheet()],
        );
    }
