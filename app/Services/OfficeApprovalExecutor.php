...
class OfficeApprovalExecutor
{
    ...
    private function controllerMap(): array
    {
        return [
            ...
            'admissions.destroy' => [\App\Http\Controllers\ApplicationController::class, 'destroy', ['key' => 'application_id', 'class' => Application::class]],
            ...
            'admission_guide.update' => [\App\Http\Controllers\AdmissionGuideController::class, 'update', null],
            'admission_guide.publish' => [\App\Http\Controllers\AdmissionGuideController::class, 'publish', null],
            'admission_guide.unpublish' => [\App\Http\Controllers\AdmissionGuideController::class, 'unpublish', null],
            ...
            'academic.sync_unit_limits' => [\App\Http\Controllers\UnitLimitController::class, 'sync', null],
            'academic.destroy_unit_limit_group' => [\App\Http\Controllers\UnitLimitController::class, 'destroyGroup', null],
            ...
            'jupeb.matric.assign' => [\App\Http\Controllers\JupebMatricController::class, 'assign', null],
            'jupeb.matric.import' => [\App\Http\Controllers\JupebMatricController::class, 'import', null],
            ...
            'results.department_submit' => [\App\Http\Controllers\ResultsController::class, 'departmentSubmit', null],
            'results.submit' => [\App\Http\Controllers\ResultsController::class, 'submit', null],
            'results.college_return' => [\App\Http\Controllers\ResultsController::class, 'collegeReturn', null],
            ...
            'settings.upload_pg_signatory_signature' => [\App\Http\Controllers\SecuritySettingsController::class, 'uploadPgSignatorySignature', null],
            'settings.delete_pg_signatory_signature' => [\App\Http\Controllers\SecuritySettingsController::class, 'destroyPgSignatorySignature', null],
