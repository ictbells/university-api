...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('grade_boundaries')) {
        ...
        if (Schema::hasTable('grades') && ! Schema::hasColumn('grades', 'sitting')) {
        ...
        if (! Schema::hasTable('grade_status_events')) {
    ...
    public function down(): void
    {
        ...
        if (Schema::hasColumn('grades', 'sitting')) {
            Schema::table('grades', function (Blueprint $table) {
